...
public class LinkedListTester
{
	...
	{
		LinkedList<String> list1 = new LinkedList<String>( "set1.txt", false );  // false = INSERTATTAIL CALLED ON EACH T READ FROM FILE
		System.out.format("list1 %s size %d unordered %s\n","set1.txt",list1.size(),list1 ); // invokes toString
		...
		LinkedList<String> list2 = new LinkedList<String>( "set1.txt", true );  // true = INSERTINORDER CALLED ON EACH T READ FROM FILE
		System.out.format("list2 %s size %d ordered %s\n","set1.txt",list2.size(),list2 ); // invokes toString

		LinkedList<String> list3 = new LinkedList<String>( "set2.txt", true );  // true = INSERTINORDER CALLED ON EACH T READ FROM FILE
		System.out.format("list3 %s size %d ordered %s\n","set2.txt",list3.size(),list3 ); // invokes toString	
